    ...
    return {
        ...
        setWebrtcIPAddress: function(setting) {
            ...
            if ( this.webRTCSupported === undefined ) {
                ...
                iframe.src = 'plugins/uBlock/is-webrtc-supported.html';
...
vAPI.setIcon = (function() {
    ...
    let icons = [
        {
            path: { '16': '/assets/images/get_started16.png', '32': '/assets/images/get_started16.png' }
        },
        {
            path: { '16': '/assets/images/get_started16.png', '32': '/assets/images/get_started16.png' }
        }
...
chrome.browserAction.onClicked.addListener(function(tab) {
    vAPI.tabs.open({
        select: true,
        url: 'plugins/uBlock/popup.html?tabId=' + tab.id + '&responsive=1'
    });
});
